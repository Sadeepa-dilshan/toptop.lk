	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Welcome to toptop.lk</title>
		...
		<body>
			...
			<section class="banner-area relative pt-lg-5 pt-sm-3" id="home">	
				<div class="overlay overlay-bg"></div>
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12 pt-lg-5 pt-sm-5">
							<h1 class="text-light">You Name It, We have It </h1>
							<h2 class="text-white">
							<span>1500+</span> Classifieds posted last week				
							</h2>	
